...
import { Button } from "@/app/Components/MovingBorder";
const Contact: React.FC = () => {
  ...
  return (
    <div className=" w-screen flex">
      <Navbar />
      <div className="w-[76%] h-screen bg-[#1E252D] overflow-x-hidden flex flex-col items-start  gap-28 pt-14">
        ...
        <div className=" w-full flex justify-between items-start pl-20 pr-10 text-white">
          <div className=" w-[30%] flex flex-col items-start justify-center gap-7">
            ...
            <p className=" w-full font-normal text-base text-gray-300">
              Feel from in get in touch with me. I'm always open to discussing
          ...
          <div className="w-[65%]  flex flex-col items-start gap-8">
            ...
            <div className="">
              <Button className=" h-[50px] w-[250px] rounded-md border-[3px] border-[#31363F] flex items-center justify-between ">
