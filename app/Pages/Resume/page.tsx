                  ...
                  <li className="mb-10 ms-6">
                    ...
                    <div className=" px-3">
                      ...
                      <p className="text-base font-normal text-gray-400">
                        ...
                        Sciences, has a strong foundation in mathematics,
                        problem solving, as well as sharp analytical skills.
                      </p>
                    </div>
                  </li>
                  <li className="mb-10 ms-6">
                  ...
                  <li className="mb-10 ms-6">
                    ...
                    <div className=" px-3">
                      ...
                      <p className="text-base font-normal text-gray-400">
                        ...
                        satisfactory achievements, building a strong foundation
                        in reading, writing, arithmetic and social skills.
                      </p>
                    </div>
                  </li>
                </ol>
                ...
                <ol className="relative border-s border-gray-700">
                  <li className="mb-10 ms-6">
                    ...
                    <div className=" px-3">
                      ...
                      <p className="text-base font-normal text-gray-400">
                        Intern as a Front-End Developer, focusing on developing
                        responsive and intuitive user interfaces using HTML,
                        CSS, JavaScript, Bootstrap, and React. Experienced in
                        working with modern frameworks such as React to create
